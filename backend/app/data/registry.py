...
REGISTRY: dict[str, Instrument] = {i.id: i for i in [
    ...
    Instrument("usdinr", "USD/INR", "fx", "fx", "INR",
               ...
               frankfurter="USD:INR", yahoo="USDINR=X",
    ...
    Instrument("eurusd", "EUR/USD", "fx", "fx", "USD",
               ...
               alphavantage=None, frankfurter="EUR:USD", yahoo="EURUSD=X",
    ...
    Instrument("gbpusd", "GBP/USD", "fx", "fx", "USD",
               ...
               alphavantage=None, frankfurter="GBP:USD", yahoo="GBPUSD=X",
    ...
    Instrument("usdjpy", "USD/JPY", "fx", "fx", "JPY",
               ...
               alphavantage=None, frankfurter="USD:JPY", yahoo="USDJPY=X",
    ...
    Instrument("usdcny", "USD/CNY", "fx", "fx", "CNY",
               ...
               frankfurter="USD:CNY", yahoo="USDCNY=X",
    ...
    Instrument("audusd", "AUD/USD", "fx", "fx", "USD",
               ...
               alphavantage=None, frankfurter="AUD:USD", yahoo="AUDUSD=X",
    ...
    Instrument("usdcad", "USD/CAD", "fx", "fx", "CAD",
               ...
               alphavantage=None, frankfurter="USD:CAD", yahoo="USDCAD=X",
    ...
    Instrument("usdchf", "USD/CHF", "fx", "fx", "CHF",
               ...
               alphavantage=None, frankfurter="USD:CHF", yahoo="USDCHF=X",
